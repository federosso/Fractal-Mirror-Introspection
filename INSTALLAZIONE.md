...
```bash
# A) interfaccia web → http://127.0.0.1:5000
python avvia_web.py

# B) run da riga di comando (la sonda è la variabile SONDA nel file: es. SONDA = "qual'è l'origine del decadimento radioattivo?")
